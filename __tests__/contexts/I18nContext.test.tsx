...
describe('I18nContext', () => {
	...
	it('should translate text using t function', () => {
		...
		// The translated text should appear (exact text depends on translation file)
	...
	it('should change translations when language changes', () => {
		...
		// The text might be the same if the key doesn't exist in both languages,
		// but the important thing is that the function doesn't break
